/* 23.11.2011 last modification: 07.02.2012
Copyright (c) 2011 by Siegfried Koepf
...
testing
gen_k_comp_init() and gen_k_comp_next()

compile
gcc -o k_comp_example k_comp_example.c k_comp.c
*/
...
//initialize
gen_result = gen_k_comp_init(vector, n, k);
...
while(gen_result == GEN_NEXT)
 ...
 gen_result = gen_k_comp_next(vector, k);
 }
